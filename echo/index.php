        ...
        <div class="layui-col-md9 layui-col-lg9">
            <?php while($this->next()): ?>
                <div class="title-article list-card">
                    <div class="list-pic"><a href="<?php $this->permalink() ?>" title="<?php $this->title() ?>"><img src="<?php if($this->fields->cover){$this->fields->cover();}else{echo thumb($this);}?>" alt="<?php $this->title() ?>" class="img-full"></a></div>
