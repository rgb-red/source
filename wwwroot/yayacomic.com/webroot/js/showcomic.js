...
function commentSubmit(callback) {
    ...
    $.ajax({
        ...
        type: 'POST',
        dataType: 'json',
        data: { message: content, cid: COMIC_MID },
        error: function (msg) {
        ...
        success: function (json) {
            if (json.msg == 'success') {
                ...
                if (typeof (PAGETYPE) != "undefined") {
                    getMangaPost(PAGEINDEX, PAGEPCOUNT, COMIC_MID, PAGETYPE);
                 }
            }
...
function getMangaPost(pageindex, pagesize, mid) {
    $(".comment-noData").hide();
    ...
    $.ajax({
        ...
        data: { pageindex: pageindex, pagesize: pagesize, mid: mid },
        error: function (msg) {
