...
<html lang="en">
	<head>
		<meta charset="UTF-8">
		<title>获赠记录 - <?=SITE()["name"]?></title>
		<meta name="keywords" content="获赠记录,<?=SITE()["keywords"]?>" />
		<meta name="Author" content="<?=SITE()["author"]?>" />
		<meta name="Description" content="赠送记录,<?=SITE()["description"]?>" />
	...
	<body class="bg-gray">
		<?php $this->load->view("layout/header", array("title"=>"获赠记录"))?>
		...
		<div id="wrapper">
			<div id="scroller">
				...
				<div class="ticket-item active">
					<div class="ticket-item-left">
						<p class="ticket-item-left-title">1500</p>
						<p class="ticket-item-left-tip">福币</p>
						<img class="ticket-item-left-right" src="/img/icon/ticket-item-left-right.png"></div>
					<div class="ticket-item-right">
						<p class="ticket-item-right-title">剩余：1500福币</p>
						<p class="ticket-item-right-subtitle">有效期至:2019-06-22 16:42</p>
						<p class="ticket-item-right-tip">来源：新手首充礼包
							<span>时间：2019-05-23 16:42</span></p>
					</div>
				</div>
				<?php $this->load->view("layout/footer")?>
				<a id="footer1" class="coin-fix-bottom" href="/account/record_lostgift" style="z-index: 1000; position: unset; display: block; margin: 10px auto; display: none;">查看已失效的福币</a></div>
			<a id="footer2" class="coin-fix-bottom" href="/account/record_lostgift" style="z-index: 1000;">查看已失效的福币</a>
		</div>
		<script src="/js/iscroll.js"></script>
		<script src="/js/wallet.js"></script>
		<script type="text/javascript">if (document.getElementById('scroller') && document.getElementById('scroller').offsetHeight + 60 >= document.getElementById('wrapper').clientHeight) {
				$('#footer1').css({
					display: 'block'
				});
				$('#footer2').hide();
			}
			var timestamp = Number('1558600923497' || '0');
			var type = Number('1');
